defmodule Project2 do
  ...
  def main(args) do
    ...
    new_node_collection =
      if topology == "3D" do
        ...
        new_node_collection =
          Enum.map(0..(num_nodes_round - 1), fn i ->
  ...
  defmodule Loop_con do
    def loop_con(start_time, convergence_count1, convergence_count2)
        when convergence_count1 == convergence_count2 do
